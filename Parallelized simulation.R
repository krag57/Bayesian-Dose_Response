...
priLikSigma2<-function(y,mu0,Gamma,Alpha,Sigma2){
  ...
  priSigma2<-dinvgamma(Sigma2,shape = 100,scale = 0.00306*99,log = T)
...
priLikABCTheSig0<-function(mu0,sig0,a,b,c,theta){
  ...
  priSig0<-dinvgamma(sig0,shape=100,scale=0.008085*99,log=T) # scale is determined from the main function.
